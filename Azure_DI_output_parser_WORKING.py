"""
WORKING VERSION - Uses EXECUTIVE PROMPT
...
- classifications: List of sensitive content with category, text, bounding_box, confidence_score, and reason
"""
...
if __name__ == '__main__':
    ...
    print("🚀 WORKING PROCESSOR - Uses EXECUTIVE PROMPT")
    print("="*60)
    print(f"Prompt: Executive Prompt (AI Document Analysis)")
    print(f"Output: extracted_names + classifications")
    ...
    for json_file in sorted(json_files):
        ...
        output_filename = f"{data_path}{base_name}_WORKING_analysis.json"
    ...
    print(f"Output files: *_WORKING_analysis.txt")
    if cached_model:
