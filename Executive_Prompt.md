...
Extract All Personal Names: Identify and list every full name of a person mentioned in the text. 

Classify Sensitive Content: Analyze the text against the classification rules provided and identify all sections that contain sensitive information. 
...
{ 
  ...
  "classifications": [ 
    ...
    { 
      ...
      "category": "3.3 Security-Marked Documents", 
